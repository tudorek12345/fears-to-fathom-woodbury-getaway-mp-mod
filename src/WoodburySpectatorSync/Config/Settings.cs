...
namespace WoodburySpectatorSync.Config
{
    ...
    public sealed class Settings
    {
        ...
        public static Settings Bind(ConfigFile config)
        {
            ...
            settings.CoopRemotePlayerAvatarSource = config.Bind("Coop", "RemotePlayerAvatarSource", RemotePlayerAvatarSource.AssetBundle, "Remote player avatar source (AssetBundle, Capsule, GameModel, Auto). AssetBundle keeps the co-op player separate from scene NPCs.");
            ...
            settings.CoopRemotePlayerAvatarId = config.Bind("Coop", "RemotePlayerAvatarId", "quaternius_regular_male", "Avatar id. Use a bundle manifest id such as quaternius_regular_male. In-scene GameModel ids are only for explicit GameModel testing.");
